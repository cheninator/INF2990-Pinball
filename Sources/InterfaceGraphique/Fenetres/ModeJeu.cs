...
namespace InterfaceGraphique
{
    ...
    public partial class ModeJeu : Form
    {
        ...
        private Timer beginGame;    ///< Timer pour commencer le jeu
        private Timer timerBille2;  ///< Timer pour bloquer la creation de billes
        ...
        bool okCreer = false;   ///< bool pour bloquer la creation de billes
        bool startGame = false; ///< bool pour commencer le jeu
