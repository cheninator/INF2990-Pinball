...
void ProgrammeINF2990::initialiser()
{
	...
	nuanceurSommets_->initialiser(opengl::Nuanceur::Type::NUANCEUR_VERTEX, "NuanceurSommetsINF2990.glsl");
	...
	nuanceurFragments_->initialiser(opengl::Nuanceur::Type::NUANCEUR_FRAGMENT, "");
