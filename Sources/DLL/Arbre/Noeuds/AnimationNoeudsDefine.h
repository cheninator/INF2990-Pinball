...
#define TRANSLATE_Z_NOEUD_TABLE SingletonGlobal::obtenirInstance()->obtenirTableMinZ() ///< Voir SingletonGlobal
#define coinGaucheTableX SingletonGlobal::obtenirInstance()->obtenirTableMaxX()  ///< Voir SingletonGlobal
#define coinGaucheTableY SingletonGlobal::obtenirInstance()->obtenirTableMaxY()	 ///< Voir SingletonGlobal
#define coinDroitTableX SingletonGlobal::obtenirInstance()->obtenirTableMinX()	 ///< Voir SingletonGlobal
#define coinDroitTableY SingletonGlobal::obtenirInstance()->obtenirTableMinY()	 ///< Voir SingletonGlobal
...
#define DEPLACEMENT_NOEUD_COUVERCLE (abs(SingletonGlobal::obtenirInstance()->obtenirTableMaxX() - SingletonGlobal::obtenirInstance()->obtenirTableMinX()) - MARGE_NOEUD_COUVERCLE) ///< Voir SingletonGlobal
#define DEMIE_LARGEUR_NOEUD_COUVERCLE (abs(boite_.coinMax.x - boite_.coinMin.x) / 2.0) ///< Voir SingletonGlobal
